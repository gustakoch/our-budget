    ...
    <div class="container-custom">
        ...
        <div class="accordion accordion-flush border shadow-sm mt-2" id="accordionResume">
            <div class="accordion-item">
                ...
                <div id="collapse-expensesOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionReceivedExpenses">
                    <div class="accordion-body accordion-expenses-type-0">
                        @if (count($receivedExpenses) > 0)
                            <div class="submitted-expenses-container mb-4 p-4 shadow">
                                <div class="submitted-expenses-content">
                                    <img style="height: 68px" src="{{ asset('/images/icons/alert.png') }}" alt="Ícone de alerta">
                                    <div class="submitted-expenses-labels">
                                        <h4>Lançamentos de saídas recebidos</h4>
                                        <span>Verifique os valores recebidos por outros usuários da plataforma.</span>
                                    </div>
                                </div>
                                <button
                                    class="btn btn-primary view-submitted-expenses"
                                    data-bs-toggle="modal"
                                    data-bs-target="#viewSubmitExpenseModal"
                                >
                                                    ...
                                                    @else
                                                        <div class="input-group" style="width: 72.46px !important;">
                                                            <span
                                                                ...
                                                                tabindex="0"
                                                                data-bs-toggle="tooltip"
                                                                title="Despesa com vínculo de pagamento para outro usuário. Não pode ser removida!"
