        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-update-submitted-expense">
                    ...
                    <div class="mb-3">
                        <label for="amount" class="form-label">Valor total da saída* <small>(em R$)</small></label>
            ...
            <div class="modal-footer border-top-0" id="modalFooterSubmittedExpense">
                ...
                <button type="button" class="btn btn-primary update-submitted-expense">Atualizar saída</button>
            </div>
        </div>
    </div>
</div>
