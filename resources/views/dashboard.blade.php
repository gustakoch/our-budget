...
<section id="recipes" class="mt-5">
    <div class="container-custom">
                    ...
                    <div id="collapse-expensesOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionResume">
                        <div class="accordion-body accordion-expenses-type-0">
                            ...
                            @elseif (count($creditCardExpenses) > 0)
                                {{-- Não exibe mensagem caso tenho despesas no cartão de crédito --}}
                            @else
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $cardExpense->credit_card }}">
                                                    <button
                                                        ...
                                                        style="background-color: #dac2c2 !important"
                                                        type="button"
                                                        data-bs-toggle="collapse"
                                                    ...
                                                    >
                                                        <strong><i class="fas fa-credit-card"></i> Cartão de crédito {{ $cardExpense->credit_card_description }} <i class="fas fa-sort-down"></i></strong>
        ...
        @else
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingOne">
                        <button
                            ...
                            style="background-color: #cea1a1 !important"
                        >
                            <strong>Precisa pagar até o dia 15</strong>
                        </button>
                    </h2>
                    <div id="collapse-expensesOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionResume">
                        <div class="accordion-body accordion-expenses-type-1">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        <tr class="align-middle no-border-bottom justify-content-end">
                                            ...
                                            <th></th>
                                            <td></td>
                                            <th id="total-amount-budgeted1" class="text-danger">{{ number_format($budgeted_amount_expenses1, 2, ',', '.') }}</th>
                                            <th id="total-amount-realized1" class="text-danger">{{ number_format($realized_amount_expenses1, 2, ',', '.') }}</th>
                                            <th id="total-amount-pending1" class="text-danger">{{ number_format($pending_amount_expenses1, 2, ',', '.') }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            @elseif (count($creditCardExpenses) > 0)
                                {{-- Não exibe mensagem caso tenho despesas no cartão de crédito --}}
                            @else
                                <span>Não há despesas lançadas neste período.</span>
                            @endif

                            @if (count($creditCardExpenses) > 0)
                                @foreach ($creditCardExpenses as $cardExpense)
                                    @if (in_array(1, $cardExpense->periods))
                                        <div class="accordion" id="accordionExample" >
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $cardExpense->credit_card }}">
                                                    <button
            ...
            <div class="accordion accordion-flush border shadow-sm" id="accordionResume">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingOne">
                        <button
                            class="accordion-button collapsed shadow-none"
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-expensesTwo"
                            aria-expanded="false"
                            aria-controls="collapse-expensesTwo"
                            style="background-color: #cea1a1 !important"
                        >
                            <strong>Pode pagar até o fim do mês</strong>
                        </button>
                    </h2>
                    <div id="collapse-expensesTwo" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionResume">
                        <div class="accordion-body accordion-expenses-type-2">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        <tr class="align-middle no-border-bottom justify-content-end">
                                            ...
                                            <th></th>
                                            <td></td>
                                            <th id="total-amount-budgeted2" class="text-danger">{{ number_format($budgeted_amount_expenses2, 2, ',', '.') }}</th>
                                            <th id="total-amount-realized2" class="text-danger">{{ number_format($realized_amount_expenses2, 2, ',', '.') }}</th>
                                            <th id="total-amount-pending2" class="text-danger">{{ number_format($pending_amount_expenses2, 2, ',', '.') }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            @elseif (count($creditCardExpenses) > 0)
                            ...
                            @if (count($creditCardExpenses) > 0)
                                @foreach ($creditCardExpenses as $cardExpense)
                                    @if (in_array(2, $cardExpense->periods))
                                        <div class="accordion" id="accordionExample" >
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $cardExpense->credit_card }}">
                                                    <button
